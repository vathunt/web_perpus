...
<!-- Lihat, Update dan Delete Banner Slide -->
<script>
    ...
    function lihatPengumuman(id) {
        $.ajax({
            ...
            $("#viewThumbnail").append("<img src='../assets/images/thumbnail/pengumuman/" + thumbnail +
                "' id='thumbnailPengumuman' class='card-img-top img-fluid' alt='Thumbnail " + response.judul_pengumuman + "'>");
            ...
            if (lampiran) {
                for (let i = 0; i < lampiran.length; i++) {
                    $('#viewLampiran').append("<li><a class='badge bg-warning' target='_blank' href='../assets/files/pengumuman/" + lampiran[i] + "'>" + namaFileLamp[i] + "</a></li>")
                }
            }
...
<div class="modal fade text-left" id="tmbPengumuman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-borderless modal-dialog-scrollable modal-full" role="document">
        <form method="POST" class="form form-vertical" id="formTmbPengumuman" action="{{ route('pengumuman.post') }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-md-8 col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="judulPengumuman" id="judulPengumuman" class="form-control" autocomplete="off">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="tglPengumuman" id="tglPengumuman" class="form-control" readonly>
                                        <div class="form-control-icon">
                            ...
                            <div class="col-md-8 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="namaLampPengumuman[]" class="form-control" id="namaLampPengumuman" placeholder="Nama File Lampiran" autocomplete="off">
                                        <input type="file" name="lampPengumuman[]" class="form-control" data-id="0" id="lampPengumuman">
                                        <button class="btn btn-primary" type="button" id="btnTmbLampiran">&plus;</button>
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="thumbPengumuman" class="font-bold">Thumbnail Pengumuman</label>
                                    <input type="file" name="thumbPengumuman" class="form-control" id="thumbPengumuman" accept="image/*">
                                </div>
                            </div>
                            <!-- <div class="input-group mb-3">
                                <label for="lampPengumuman" class="font-bold">Lampiran Pengumuman</label>
...
<div class="modal fade text-left" id="lhtPengumuman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Tanggal Pengumuman : <span class="font-bold" id="viewTanggal"></span></li>
...
<div class="modal fade text-left" id="hapusPengumuman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-borderless modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
...
<script>
    $(document).ready(function() {
        ...
        $("#btnTmbLampiran").on('click', function(event) {
            ...
            $("<div id='remove_" + i + "'><div class='input-group'><input type='text' name='namaLampPengumuman[]' class='form-control' placeholder='Nama File Lampiran' autocomplete='off'><input type='file' name='lampPengumuman[]' class='form-control' data-id='" + i + "'><button type='button' class='btn btn-danger' onclick=\"hapus_lampiran('" + i + "')\">&times;</button></div><div id='errLampPengumuman-" + i + "'></div><p></p></div>").appendTo($("#inputLampiran"));
        });
...
<!-- Datepicker -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css') }}">
<script type="text/javascript" src="{{ asset('assets/vendors/bootstrap-datepicker/dist/js/bootstrap-datepicker.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/vendors/bootstrap-datepicker/dist/locales/bootstrap-datepicker.id.min.js') }}"></script>

<script>
    $('#tglPengumuman').datepicker({
        format: 'yyyy-mm-dd',
        autoclose: true,
        clearBtn: true,
        language: 'id',
