                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form method="POST" class="form" id="formSlide" action="{{ route('slide.post') }}"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-muted">&nbsp;
                                                        <i class="text-primary font-bold">*) Ukuran gambar akan diubah
                                                            ke 1600x800 pixel</i>
                                                    </small>
...
function hapusBanner(id, image) {
    ...
    $("#previewHapusBanner").append(`<img src='../images/slider-main/${gambar}' style='max-width: 100%;'>`);
...
function editBanner(id) {
    $.ajax({
        ...
        $("#previewBannerSlide").append(
            `<img src='../images/slider-main/${gambar}' id='fotoBannerTampil' style='max-width: 100%;'>`);
...
<div class="modal fade text-left" id="editBanner" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160"
    ...
    <div class="modal-dialog modal-borderless modal-dialog-scrollable modal-lg" role="document">
        <form method="POST" class="form form-vertical" id="formSlideEdit" action="{{ route('slide.update') }}"
            enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="col-12">
                                <div class="col-md-12 mb-1">
                                    <div class="input-group mb-3">
                                        ...
                                        <small class="text-muted">&nbsp;<i class="text-primary font-bold">*) Ukuran
...
$('#formSlide').validate({
    ...
    errorPlacement: (error, element) => element.attr("name") == "gambar_slide" ? error.appendTo($(
        '#errGambarSlide')) : error.insertAfter(element),
    highlight: (element, errorClass, validClass) => $(element).addClass(errorClass).removeClass(
        validClass),
    unhighlight: (element, errorClass, validClass) => $(element).removeClass(errorClass).addClass(
        validClass)
});
</script>
...
$('#formSlideEdit').validate({
    ...
    highlight: (element, errorClass, validClass) => $(element).addClass(errorClass).removeClass(validClass),
    unhighlight: (element, errorClass, validClass) => $(element).removeClass(errorClass).addClass(validClass)
});
</script>
