...
<section id="news" class="news">
    <div class="container">
        ...
        <div class="general-btn text-center mt-4">
            <a class="btn btn-primary" href="#">Berita Lainnya</a>
        </div>
...
<section id="article" class="news">
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                <!-- <h2 class="section-title">Berita Terkini</h2> -->
                <h3 class="section-sub-title">Artikel/Opini</h3>
            </div>
        </div>
        <!--/ Title row end -->
        ...
        <div class="general-btn text-center mt-4">
            <a class="btn btn-primary" href="#">Artikel Lainnya</a>
        </div>
