                ...
                <nav class="navbar navbar-expand-lg navbar-dark p-0">
                  ...
                  <div id="navbar-collapse" class="collapse navbar-collapse">
                      <ul class="nav navbar-nav mr-auto">
                        <li class="nav-item"><a href="{{ route('home') }}" class="nav-link"><i class="fas fa-home"></i> Beranda</a></li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Tautan Penting <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Survei <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu">
